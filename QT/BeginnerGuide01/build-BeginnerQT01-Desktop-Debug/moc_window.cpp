...
static const char qt_meta_stringdata_Window[] = {
    "Window\0\0int\0normalizedValue(int)\0value\0"
    "slotNormalizeValue(int)\0"
};
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { int _r = _t->normalizedValue((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 1: _t->slotNormalizeValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
int Window::normalizedValue(int _t1)
{
    int _t0;
